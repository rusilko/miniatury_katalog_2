...
describe "Authentication" do
  ...
  describe "authorization" do
    ...
    describe "for non-signed-in users" do
      ...
      describe "in the Users controller" do
        ...
        describe "in the Relationships controller" do
          describe "submitting directly to the create action" do
            before { post relationships_path }
            specify { response.should redirect_to(signin_path) }
          end
          describe "submitting directly to the destroy action" do
      ...
      describe "when attempting to visit a protected page" do
        ...
        describe "after signin in" do
          ...
          describe "after signin in again" do
            before do
              visit signin_path
              fill_in "Email",  with: user.email
              fill_in "Password",   with: user.password
            ...
            it "should render the default page (profile page)" do
    ...
    describe "as admin user" do
      ...
      it "admin should not be able to destroy himself" do
